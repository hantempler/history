...
os.makedirs(EDITION_CONFIG["history"]["data_dir"], exist_ok=True)
os.makedirs(ASSETS_DIR, exist_ok=True)

DATA_DIR = EDITION_CONFIG["history"]["data_dir"]
...
def get_daily_dir(target_date_str=None, edition="history"):
    ...
    daily_dir = os.path.join(EDITION_CONFIG["history"]["data_dir"], formatted_date)
